...
async def get_stundenplan():
    ...
    return (Embed(title='Stundenplan', description='Aktueller Stundenplan der 11 BGI.',
            ...
            .set_image(
        url='https://media.discordapp.net/attachments/883364257364844615/883364663394451556/unknown.png'))
